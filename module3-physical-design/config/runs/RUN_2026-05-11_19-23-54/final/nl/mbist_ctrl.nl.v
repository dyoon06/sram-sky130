module mbist_ctrl (clk,
 ...
 sky130_fd_sc_hd__inv_2 _146_ (.A(net70),
    .Y(_137_));
 ...
 sky130_fd_sc_hd__and3_1 _186_ (.A(\state[6] ),
    ...
    .C(_055_),
    .X(_065_));
 sky130_fd_sc_hd__a21o_1 _187_ (.A1(net69),
    .A2(_064_),
    .B1(_065_),
    .X(_004_));
 ...
 sky130_fd_sc_hd__a211o_1 _193_ (.A1(\state[0] ),
    ...
    .C1(net46),
    .X(_069_));
 sky130_fd_sc_hd__a211o_1 _194_ (.A1(net60),
    .A2(_047_),
    .B1(_067_),
    .C1(_069_),
    .X(_000_));
 ...
 sky130_fd_sc_hd__a21o_1 _205_ (.A1(net20),
    ...
    .B1(net45),
    .X(_080_));
 sky130_fd_sc_hd__a21o_1 _206_ (.A1(net47),
    .A2(_079_),
    .B1(_080_),
    .X(_010_));
 sky130_fd_sc_hd__a21o_1 _207_ (.A1(net21),
    ...
    .B1(net45),
    .X(_081_));
 sky130_fd_sc_hd__a21o_1 _208_ (.A1(net51),
    .A2(_079_),
    .B1(_081_),
    .X(_011_));
 sky130_fd_sc_hd__a21o_1 _209_ (.A1(net22),
    ...
    .B1(net45),
    .X(_082_));
 sky130_fd_sc_hd__a21o_1 _210_ (.A1(net53),
    .A2(_079_),
    .B1(_082_),
    .X(_012_));
 sky130_fd_sc_hd__a21o_1 _211_ (.A1(net23),
    ...
    .B1(net45),
    .X(_083_));
 sky130_fd_sc_hd__a21o_1 _212_ (.A1(net50),
    .A2(_079_),
    .B1(_083_),
    .X(_013_));
 sky130_fd_sc_hd__a21o_1 _213_ (.A1(net24),
    ...
    .B1(net46),
    .X(_084_));
 sky130_fd_sc_hd__a21o_1 _214_ (.A1(net54),
    .A2(_079_),
    .B1(_084_),
    .X(_014_));
 sky130_fd_sc_hd__a21o_1 _215_ (.A1(net25),
    ...
    .B1(net46),
    .X(_085_));
 sky130_fd_sc_hd__a21o_1 _216_ (.A1(net48),
    .A2(_079_),
    .B1(_085_),
    .X(_015_));
 sky130_fd_sc_hd__a21o_1 _217_ (.A1(net26),
    ...
    .B1(net46),
    .X(_086_));
 sky130_fd_sc_hd__a21o_1 _218_ (.A1(net52),
    .A2(_079_),
    .B1(_086_),
    .X(_016_));
 sky130_fd_sc_hd__a21o_1 _219_ (.A1(net27),
    ...
    .B1(net45),
    .X(_087_));
 sky130_fd_sc_hd__a21o_1 _220_ (.A1(net49),
    .A2(_079_),
    .B1(_087_),
    .X(_017_));
 ...
 sky130_fd_sc_hd__nand2_1 _266_ (.A(_048_),
    .B(_122_),
    .Y(_124_));
 sky130_fd_sc_hd__o211a_1 _267_ (.A1(net59),
    .A2(_123_),
    .B1(_124_),
    .C1(net42),
    .X(_027_));
 sky130_fd_sc_hd__o211a_1 _268_ (.A1(net57),
    .A2(_053_),
    .B1(_121_),
    .C1(net43),
    .X(_028_));
 ...
 sky130_fd_sc_hd__o211a_1 _277_ (.A1(net1),
    ...
    .C1(net41),
    .X(_032_));
 sky130_fd_sc_hd__or2_1 _278_ (.A(net68),
    .B(_144_),
    .X(_130_));
 sky130_fd_sc_hd__o211a_1 _279_ (.A1(net2),
    ...
    .C1(net41),
    .X(_033_));
 sky130_fd_sc_hd__or2_1 _280_ (.A(net71),
    .B(_144_),
    .X(_131_));
 sky130_fd_sc_hd__o211a_1 _281_ (.A1(net3),
    ...
    .C1(net41),
    .X(_034_));
 sky130_fd_sc_hd__or2_1 _282_ (.A(net67),
    .B(_144_),
    .X(_132_));
 sky130_fd_sc_hd__o211a_1 _283_ (.A1(net4),
    ...
    .C1(net41),
    .X(_035_));
 sky130_fd_sc_hd__or2_1 _284_ (.A(net66),
    .B(_144_),
    .X(_133_));
 sky130_fd_sc_hd__o211a_1 _285_ (.A1(net5),
    ...
    .C1(net41),
    .X(_036_));
 sky130_fd_sc_hd__or2_1 _286_ (.A(net72),
    .B(_144_),
    .X(_134_));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold11 (.A(net28),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold12 (.A(_028_),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold13 (.A(net37),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold14 (.A(\state[4] ),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold15 (.A(_000_),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold16 (.A(\state[6] ),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold17 (.A(\state[3] ),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold18 (.A(\state[2] ),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold19 (.A(net38),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold20 (.A(\read_data[4] ),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold21 (.A(\read_data[3] ),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold22 (.A(\read_data[1] ),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold23 (.A(\state[1] ),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold24 (.A(diag_captured),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold25 (.A(\read_data[2] ),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold26 (.A(\read_data[5] ),
    .X(net72));
 ...
 sky130_fd_sc_hd__decap_6 FILLER_22_126 ();
